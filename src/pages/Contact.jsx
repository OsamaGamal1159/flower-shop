...
function Contact() {
  return (
    <div>
      <div className='mb-40 grid grid-cols-2 mx-40 gap-16 text-gray-800 flex items-center'>
        <div className='w-full h-[520px] bg-cover bg-center bg-no-repeat bg-red-300'
            style={{ backgroundImage:`url(${bg_contact})`}}>
        </div>
        <div className='flex flex-col justify-center gap-5 shadow-category pl-10 h-[400px] rounded-2xl'>
